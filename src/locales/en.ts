...
export default {
  ...
  appModes: {
    ...
    switchToBrainstorm: 'Switch to Brainstorm',
  ...
  brainstorm: {
    ...
    canvasCleared: 'Canvas has been cleared.',
    emptyBoardSaveError: 'Cannot save an empty board.',
    untitled: 'Untitled Board',
    boardSaved: 'Board "{name}" has been saved.',
    boardLoaded: 'Board "{name}" has been loaded.',
    boardDeleted: 'Board "{name}" has been deleted.',
    selectFont: 'Select Font',
    clearCanvas: 'Clear Canvas',
    confirmClearTitle: 'Clear the entire canvas?',
    confirmClearDescription: 'This will delete all topics and cannot be undone.',
    clearButton: 'Clear Canvas',
    saveBoard: 'Save Board',
    openSaved: 'Open Saved Boards',
    savedBoardsTitle: 'Saved Boards',
    savedBoardsDescription: 'Select a board to load it onto the canvas.',
    noSavedBoards: 'You have no saved boards yet.',
    loadButton: 'Load this board',
    confirmDeleteBoardTitle: 'Delete this board?',
    confirmDeleteBoardDescription: 'Are you sure you want to permanently delete "{name}"?',
  },
  novelistMode: {
    ...
    confirmDeleteDescription: 'Are you sure you want to delete "{itemName}"? This action cannot be undone.',
    deleteButton: 'Delete',
    cancelButton: 'Cancel',
    itemDeleted: '"{itemName}" has been deleted.',
  ...
  footer: {
    copyright: '© {year} redraft. All rights reserved.',
  },
