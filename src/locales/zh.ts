...
export default {
  ...
  brainstorm: {
    ...
    branchDeleted: '已删除分支。',
    canvasCleared: '画布已清空。',
    emptyBoardSaveError: '无法保存空白的白板。',
    untitled: '未命名白板',
    boardSaved: '白板 “{name}” 已保存。',
    boardLoaded: '白板 “{name}” 已加载。',
    boardDeleted: '白板 “{name}” 已删除。',
    selectFont: '选择字体',
    clearCanvas: '清空白板',
    confirmClearTitle: '要清空整个白板吗？',
    confirmClearDescription: '这将删除所有主题且无法撤销。',
    clearButton: '清空白板',
    saveBoard: '保存白板',
    openSaved: '打开已保存',
    savedBoardsTitle: '已保存的白板',
    savedBoardsDescription: '选择一个白板以加载到画布上。',
    noSavedBoards: '您还没有保存任何白板。',
    loadButton: '加载此白板',
    confirmDeleteBoardTitle: '删除这个白板吗？',
    confirmDeleteBoardDescription: '您确定要永久删除 “{name}” 吗？',
  },
  novelistMode: {
    manuscript: '手稿',
    characters: '角色',
    ...
    confirmDeleteDescription: '您确定要删除“{itemName}”吗？此操作无法撤销。',
    deleteButton: '删除',
    cancelButton: '取消',
    itemDeleted: '“{itemName}”已被删除。',
    editorPlaceholder: '在此开始写作...',
    chapterTitlePlaceholder: '章节标题...',
    characterNamePlaceholder: '角色姓名...',
    settingNamePlaceholder: '设定名称...',
    noteTitlePlaceholder: '笔记标题...',
    characterProfile: '角色简介',
    settingDescription: '设定描述',
    noteContent: '笔记内容',
  },
  treeMode: {
